      ...
      items: [
        {
          ...
          dimensions: "3723px X 703px (W x H)",
          patterns: [
            round_250_1,
            round_250_2,
            round_250_3,
        ...
        // },
        {
          ...
          dimensions: "3708px X 1140px (W x H)",
          patterns: [
            round_500_1,
            round_500_2,
            round_500_3,
      ...
      items: [
        {
          ...
          path: rs300,
          image: rs300mlImage,
          dimensions: "3866px X 720px (W x H)",
          patterns: [
            rs_300_1,
            rs_300_2,
            rs_300_3,
        ...
        },
        {
          ...
          path: rs500,
          image: rs500mlImage,
          dimensions: "3857px X 1075px (W x H)",
          patterns: [
              rs_500_1,
              rs_500_2,  
              rs_500_3,
        ...
        },
        {
          ...
          path: rs750,
          image: rs750mlImage,
          dimensions: "4853px X 998px (W x H)",
          patterns: [
            rs_750_1,
            rs_750_2,
            rs_750_1,
        ...
        },
        {
          ...
          path: rs1000,
          image: rs1000mlImage,
          dimensions: "4853px X 1277px (W x H)",
          patterns: [
            rs_1000_1,
            rs_1000_2,
            rs_1000_1,
          ...
          items: [
            {
              ...
              path: sb250,
              image: sb250gImage,
              dimensions: "1512px X 1152px (W x H)",
              patterns: [
                sb_250_1,
                sb_250_2,
                sb_250_3,
            ...
            },
            {
              ...
              path: sb500,
              image: sb500gImage,
              dimensions: "2050px X 1441px (W x H)",
              patterns: [
                sb_500_1,
                sb_500_2,
                sb_500_3,
            ...
            },
            {
              ...
              path: sb1000,
              image: sb1000gImage,
              dimensions: "2623px X 1867px (W x H)",
              patterns: [
                sb_1000_1,
                sb_1000_2,
                sb_1000_3,
          ...
          items: [
            {
              ...
              dimensions_tub: "5474px X 666px (W x H)", // 4 SIDE dimension
              lidPatterns: [
                sb_250_4_1_1,
                sb_250_4_2_1,
                sb_250_4_3_1,
            ...
            },
            {
              ...
              path: sb_4_500,
              image: sb500gImage,
              dimensions_lid: "2103px X 1489px (W x H)",
              dimensions_tub: "7111px X 833px (W x H)",
              lidPatterns: [
                sb_500_4_1_2,
                sb_500_4_2_2,
                sb_500_4_3_2,
...

    {
      ...
      items: [
        // ... existing items (now with 1000gms added)
        {
          ...
          image: sbte250gImage,
          dimensions_lid: "1630px X 1288px (W x H)",
          dimensions_tub: "2398px X 2044px (W x H)",
          lidPatterns: [
            sb_te_250_1_1,
            sb_te_250_2_1,
            sb_te_250_3_1,
        ...
        },
        {
          ...
          path: te_500,
          image: sbte500gImage,
          dimensions_lid: "2050px X 1442px (W x H)",
          dimensions_tub: "2847px X 2269px (W x H)",
          lidPatterns: [
            sb_te_500_1_2,
            sb_te_500_2_2,
            sb_te_500_3_2,
